...
class Device:
    ...
    Attributes:
        device_id (str): Device MAC address used as a public identifier.
        device_token (str): Secret token generated by the cloud and used to
    ...
    def __init__(
        ...
        status: str,
        created_at: datetime,
        display_mode: str = DisplayMode.DISPLAY_MODE_WEIGHT.name
    ):
